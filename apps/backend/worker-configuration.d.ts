/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 49354f75e49036192c47df4e57236b58)
// Runtime types generated with workerd@1.20250525.0 2025-06-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DuraUsersKV: KVNamespace;
		WORKER_ENV: string;
		...
		Control: DurableObjectNamespace<import("./src/index").Control>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_ENV" | "GOOGLE_API_KEY" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "BASE_URL" | "LOG_LEVEL" | "OPEN_ROUTER_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
